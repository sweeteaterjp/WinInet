========================================================================
    コンソール アプリケーション: WinInetRequestTest プロジェクトの概要
========================================================================

この WinInetRequestTest アプリケーションは、AppWizard により作成されました。

このファイルには、WinInetRequestTest 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


WinInetRequestTest.vcxproj
...
WinInetRequestTest.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、WinInetRequestTest.pch 
